...
Proj4js = {
	...
	transform: function(source, dest, point) {
		...
		if ((source.srsProjNumber == "900913" && dest.datumCode != "WGS84" && !dest.datum_params) || (dest.srsProjNumber == "900913" && source.datumCode != "WGS84" && !source.datum_params)) {
...
Proj4js.datum = Proj4js.Class({
	...
	compare_datums: function(dest) {
		if (this.datum_type != dest.datum_type) {
			...
			return strcmp(pj_param(this.params, "snadgrids").s, pj_param(dest.params, "snadgrids").s) == 0;
		} else {
			return true;
		}
	},
